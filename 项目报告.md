...
<div align=center><img src="animeGAN1.png"></div>  
生成器的网络可以看作是编码器-解码器网络。其中主要的模块有标准卷积、深度可分离卷积、残差网络、上采样和下采样模块  
<div align=center><img src="animeGAN2.png"></div>  
...
&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;而判别器只需要对生成器生成的模型进行判别，因此使用传统的CNN网络即可.以上使用的生成器和判别器网络构建位于./net文件夹的generator.py 和 discriminator.py 文件中   
...
图片2：
<div class="inline-block">
	<img src="AnimeStylized/res/image/input/2.jpg" alt="add trip" width=400 >
    <img src="AnimeStylized/res/image/output/2-hayao.jpg" alt="delete account" width=400>
    </div>
    <div class="inline-block">
    <img src="AnimeStylized/res/image/output/2-paprika.jpg" alt="delete account" width=400>
    <img src="AnimeStylized/res/image/output/2-shinkai.jpg" alt="delete account" width=400>
</div>
</div>
...
<img src="AnimeStylized/res/face_img/output/2.jpg" alt="delete account" width=400>  
